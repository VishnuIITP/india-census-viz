...
This Streamlit app visualizes district-level population growth in India using census data.  
It combines geospatial centroids with census population figures to provide an interactive map and insights.
